<div class="p-6">
    ...
    {{-- Formulário principal do Livewire --}}
    <form wire:submit.prevent="save" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    <label for="tombamento" class="block text-sm font-medium text-gray-700">Tombamento (Patrimônio)
                        *</label>
                    <input type="text" id="tombamento" wire:model="tombamento" required
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                    {{-- @error('tombamento') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror --}}
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="nome_usuario" wire:model="nome_usuario" required
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                {{-- Tamanho Disco --}}
                <div>
                    <label for="tamanho_disco" class="block text-sm font-medium text-gray-700">Tamanho Disco* (SSD/HDD)</label>
<select id="tamanho_disco" wire:model="tamanho_disco"
    ...
    <optgroup label="HDD (Hard Disk Drive)">
        ...
        <option value="HDD 1 TB">1 TB HDD</option>
                ...
                {{-- Tamanho Memória --}}
                <div>
                    <label for="tamanho_memoria" class="block text-sm font-medium text-gray-700">Memória RAM (quantidade)*</label>
...
<select id="pente_ram" wire:model="pente_ram"
    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
    ...
    <option value="DDR4">DDR4</option>
                ...
                {{-- Sistema Operacional --}}
                <div>
                    <label for="sistema_operacional" class="block text-sm font-medium text-gray-700">Sistema Operacional*</label>
...
<select id="licenca_so" wire:model="licenca_so"
    ...
    <option value="Free">Free</option>
        ...
        {{-- SEÇÃO 3: PERIFÉRICOS E DETALHES --}}
        <div class="bg-white shadow-xl rounded-lg p-6">
            <h3 class="text-xl font-semibold mb-4 border-b pb-2 text-indigo-700">3. Periféricos e Acessórios</h3>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">

                {{-- Teclado --}}
                <div class="md:col-span-2">
                    <label for="teclado" class="block text-sm font-medium text-gray-700">Teclado</label>
                        <select id="teclado"  class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500"wire:model="teclado">
                            <option value="">-- Selecionar --</option>
                ...
                <div class="md:col-span-2">
                    <label for="mouse" class="block text-sm font-medium text-gray-700">Mouse</label>
                        <select id="mouse"  class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500"wire:model="mouse">
                            <option value="">-- Selecionar --</option>
                            <option value="logitech">LogiTech</option>
                            <option value="não">Não</option>
                        </select>
                ...
                {{-- Quantidade de Telas --}}
                <div>
                    <label for="quantidade_telas" class="block text-sm font-medium text-gray-700">Quantidade de
                        Telas</label>
                    <input type="number" id="quantidade_telas" wire:model="quantidade_telas" min="0"
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                ...
                <div class="md:col-span-2">
                    <label for="estabilizador" class="block text-sm font-medium text-gray-700">Estabilizador</label>
                        <select id="estabilizador"  class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500"wire:model="estabilizador">
                            <option value="">-- Selecionar --</option>
                ...
                <div class="md:col-span-2">
                    <label for="carrinho" class="block text-sm font-medium text-gray-700">Carrinho</label>
                        <select id="carrinho"  class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500"wire:model="carrinho">
                            <option value="">-- Selecionar --</option>
                            <option value="sim">Sim</option>
                            <option value="não">Não</option>
                        </select>
