        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="ip" x-mask="99.99.9.999" placeholder="10.52.0.0" wire:model="ip"
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                    <div class="text-red-500">@error('ip') {{ $message }} @enderror</div>
                </div>
                {{-- Nome da Máquina --}}
                <div>
                    <label for="nome_maquina" class="block text-sm font-medium text-gray-700">Nome da Máquina *</label>
                    <input type="text" id="nome_maquina" value="PGM" x-mask="PGM999" placeholder="PGM000"
                        wire:model="nome_maquina"
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                    <div class="text-red-500">@error('nome_maquina') {{ $message }} @enderror</div>
                </div>
                <div>
                    <label for="lotacao" class="block text-sm font-medium text-gray-700">Lotação *</label>
                    <select id="lotacao" wire:model="lotacao"
                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div class="text-red-500">@error('lotacao') {{ $message }} @enderror</div>
            ...
            <div class="bg-white shadow-xl rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <div class="text-red-500">@error('processador') {{ $message }} @enderror</div>
                    ...
                    <div>
                        ...
                        <input type="text" id="placa_mae" wire:model="placa_mae"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                        <div class="text-red-500">@error('placa_mae') {{ $message }} @enderror</div>
                    ...
                    <div>
                        ...
                        <div class="text-red-500">@error('tamanho_disco') {{ $message }} @enderror</div>
                    ...
                    <div>
                        <label for="tamanho_memoria" class="block text-sm font-medium text-gray-700">Memória RAM
                            (quantidade)*</label>
                        <select id="memoria_ram" wire:model="memoria_ram"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                            <option value="">-- Selecionar --</option>
                        ...
                        <div class="text-red-500">@error('memoria_ram') {{ $message }} @enderror</div>

                    </div>

                    {{-- Pente RAM --}}
                    <div>
                        <label for="pente_ram" class="block text-sm font-medium text-gray-700">Tipo de Memória
                            RAM*</label>
                        ...
                        <div class="text-red-500">@error('tipo_memoria') {{ $message }} @enderror</div>
                    ...
                    <div>
                        ...
                        <div class="text-red-500">@error('sistema_operacional') {{ $message }} @enderror</div>
                    </div>

                    {{-- Licença SO --}}
                    <div>
                        <label for="licenca_so" class="block text-sm font-medium text-gray-700">SO possui
                            licença*</label>
                        ...
                        <div class="text-red-500">@error('licenca_so') {{ $message }} @enderror</div>
                    </div>
                </div>
            </div>
            {{-- SEÇÃO 3: Monitores --}}
                    ...
                    <div class="border border-gray-200 p-4 mb-4 rounded-md relative bg-gray-50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <select id="monitor_tamanho_tela_{{ $index }}"
                                    wire:model="monitores.{{ $index }}.tamanho_tela"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                                    <option value="">-- Selecionar --</option>
                            ...
                            <div>
                                ...
                                <select id="monitor_tipo_conexao_{{ $index }}"
                                    wire:model="monitores.{{ $index }}.tipo_conexao"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-indigo-500 focus:border-indigo-500">
                                    <option value="">-- Selecionar --</option>
            ...
            <div class="bg-white shadow-xl rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="text-red-500">@error('teclado') {{ $message }} @enderror</div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="text-red-500">@error('mouse') {{ $message }} @enderror</div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="text-red-500">@error('estabilizador') {{ $message }} @enderror</div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="text-red-500">@error('carrinho') {{ $message }} @enderror</div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="text-red-500">@error('observacoes') {{ $message }} @enderror </div>
                </div>
            </div>
